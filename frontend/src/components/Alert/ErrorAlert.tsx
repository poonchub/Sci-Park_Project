  ...
  return (
    <Alert
      ...
      sx={{
        ...
        backgroundColor: '#fef2f2', // Light red background for better contrast
        color: '#991b1b', // Dark red text for better readability
        padding: '12px',
    ...
    >
      <AlertTitle style={{ color: "#991b1b", fontWeight: "bold" }}>Error</AlertTitle>
      {message}
    </Alert>
  );
};
