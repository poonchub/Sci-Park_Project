...
const ApexInvoiceRevenueBarChart = (props: {
    invoicePaymentData: PaymentInterface[];
    height: number;
    dateRange?: { start: Dayjs | null; end: Dayjs | null };
    selectedDateOption: string;
}) => {
    const { invoicePaymentData, height, dateRange, selectedDateOption } = props;
    ...
    const { bookingSeries, formattedCategories } = useMemo(() => {
        ...
        const bookingSum = sumByKey(invoicePaymentData);
    ...
    }, [invoicePaymentData, dateRange, selectedDateOption]);
...
export default ApexInvoiceRevenueBarChart;